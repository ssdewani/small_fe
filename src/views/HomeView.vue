...
<template>
    ...
    <div class="grid grid-cols-12 max-w-7xl mx-auto font-display text-slate-800">
        ...
        <!-- Desktop RightBar -->
        <RightBar class="col-span-3 hidden lg:block" :preferredTopics="preferredTopics"
            :suggestedTopics="suggestedTopics" @remove-topic="removeTopic" @add-topic="addTopic"
            @regenerate="regenerateFeed" />
    </div>
</template>
